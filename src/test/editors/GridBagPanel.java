...
class GridBagPanel extends JPanel implements GridBagConstants {
   ...
   * @param insets margins to add around component within its allocated space.
   */
  public void add(Container cnt, Component cmp, int gridx, int gridy,
		  int gridwidth, int gridheight, int anchor, int fill, 
		  double weightx, double weighty, Insets insets){
    ...
    // esto se hace para que el setEnabled() afecte a todos los componentes
    // del panel

    public void setEnabled(boolean b)
    {
        super.setEnabled(b);
        setEnabledRecursivo(this, b);
    }

    private void setEnabledRecursivo(Container c, boolean b)
    {
        ...
        for (int i = 0; i < numChildren; i++)
        {
            ...
            if (child instanceof Container)
                setEnabledRecursivo((Container) child, b);
        }
    }
}
